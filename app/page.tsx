    ...
    <div className="min-h-screen overflow-x-hidden bg-[#0A0A12] font-sans text-white">
      ...
      <main>
        <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 pb-20 pt-32 text-center md:px-8">
          <div className="pointer-events-none absolute left-1/2 top-[20%] h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(circle,rgba(108,92,231,0.15)_0%,transparent_70%)]" />
          <div className="pointer-events-none absolute right-[10%] top-[60%] h-[300px] w-[300px] bg-[radial-gradient(circle,rgba(162,155,254,0.08)_0%,transparent_70%)]" />

          <div className="relative z-10 inline-flex items-center gap-2 rounded-full border border-[#6C5CE7]/30 bg-[#6C5CE7]/10 px-5 py-2">
          ...
          <h1 className="relative z-10 mt-8 max-w-4xl text-[42px] font-extrabold leading-[0.98] tracking-[-2px] md:text-[72px]">
            Il tuo autopilota
            <br />
            per i social media
          </h1>

          <p className="relative z-10 mt-6 max-w-[560px] text-lg leading-8 text-white/55">
          ...
          <div className="relative z-10 mt-16 grid grid-cols-2 gap-x-8 gap-y-8 md:flex md:flex-wrap md:justify-center md:gap-12">
            {[
        ...
        <section id="funzionalita" className="mx-auto max-w-7xl px-6 py-24 md:px-8">
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="rounded-2xl border border-white/6 bg-white/[0.02] p-8 transition duration-300 hover:-translate-y-1 hover:border-[#6C5CE7]/30 hover:bg-[#6C5CE7]/[0.05]"
              >
        ...
        <section id="come-funziona" className="relative px-6 py-24 md:px-8">
          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {steps.map((step) => (
                <div key={step.number} className="relative rounded-[20px] border border-white/6 bg-white/[0.02] px-8 pb-10 pt-10">
        ...
        <section id="pricing" className="mx-auto max-w-7xl px-6 py-24 md:px-8">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-[#6C5CE7]/20 bg-gradient-to-br from-[#6C5CE7]/10 to-[#A29BFE]/5 px-8 py-6">
            <div>
        ...
        <section className="px-6 py-20 md:px-8">
          <div className="relative mx-auto max-w-5xl overflow-hidden rounded-3xl border border-[#6C5CE7]/20 bg-gradient-to-br from-[#6C5CE7]/15 to-[#A29BFE]/5 px-8 py-16 text-center md:px-12">
            <div className="pointer-events-none absolute right-[-100px] top-[-100px] h-[300px] w-[300px] bg-[radial-gradient(circle,rgba(108,92,231,0.10),transparent)]" />
      ...
      <footer className="border-t border-white/6 px-6 pb-8 pt-16 md:px-8">
        <div className="mx-auto mb-12 grid max-w-7xl gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="space-y-2.5 text-[13px] text-white/40">
              ...
              <a href="#" className="block">Demo</a>
              <a href="#" className="block">API Docs</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2.5 text-[13px] text-white/40">
              ...
              <a href="#" className="block">Contatti</a>
              <a href="#" className="block">Lavora con noi</a>
            </div>
          </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-4 border-t border-white/6 pt-6 text-[12px] text-white/25 md:flex-row md:items-center md:justify-between">
